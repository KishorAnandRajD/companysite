...
import { fetchFoodWithFilter as fefetchFoodWithFilterActionCreator } from '../../actions/FoodList/action_creators';
...
class SearchFoodItems extends Component {
    ...
    handleOnSubmit=(e)=>{
        ...
        this.props.fetchFoodWithFilter(this.props.dataCopyForSearch, this.state.searchText);
    }
...
const mapStateToProps = state => ({
    dataCopyForSearch: state.listFood.dataCopyForSearch,
  })

const mapDispatchToProps = (dispatch) => ({
    fetchFoodWithFilter: (data, payload) => dispatch(fefetchFoodWithFilterActionCreator(data, payload))
  })

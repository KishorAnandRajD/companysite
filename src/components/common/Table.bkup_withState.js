...
export default class Table extends Component {
  ...
  componentWillMount(){
    console.log('inside componentWillMount of Table this.props:', this.props);
  ...
  render() {
    console.log('inside Table this.props:', this.props);
  ...
  console.log('JSONVal:', JSONVal[col]);
    ...
    return (
      <div className="table-custom table-responsive">
        <Pagination getPageData={this.getPageData} totalNoOfPages={totalNoOfPages} currentPage={this.state.currentPage}/>
        <table className="table">
          ...
          <tbody>
              {this.state.pageTableData !== undefined && this.state.pageTableData.length !== undefined
              ? this.state.pageTableData.map((rowData)=>{
